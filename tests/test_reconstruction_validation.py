...
def test_reconstruction_can_save_per_object_debug_artifacts(tmp_path):
    ...
    expected_names = [
        ...
        "06_accepted_target_bbox.png",
        "07_directional_seed.png",
        "08_filtered_reconstruction_mask.png",
        "09_composition_mask.png",
        "10_source.png",
        "11_roi_real_pixels.png",
        "12_target_modal_protected.png",
        "13_occluder_mask.png",
        "14_full_occluder_in_roi.png",
        "15_foreign_modal_inside_bbox.png",
        "16_foreign_modal_outside_bbox.png",
        "17_replacement_domain.png",
        "18_replaceable_foreign_inside.png",
        "19_protected_foreign_inside.png",
        "20_foreign_protection.png",
        "21_protected_source_pixels.png",
        "22_accepted_model_rgb_mask.png",
        "23_generation_before_dilation.png",
        "24_generation_after_dilation.png",
        "25_generation_mask.png",
        "26_base_output_512.png",
        "27_sr_output.png",
        "28_model_output.png",
        "29_validated_output.png",
    ]
