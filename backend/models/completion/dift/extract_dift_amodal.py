...
if __name__ == '__main__':
    ...
    img_dir = 'images' # fill in the path to the image directory
    save_dir = 'feature' # fill in the path to the directory of saving the extracted features
    img_name_list = [f for f in os.listdir(img_dir) if f.lower().endswith(('.png', '.jpg', '.jpeg'))] # fill in the path to the image name list
    ...
    for img_name in img_name_list:
        ...
        for key_i in ft.keys():
            cur_folder = os.path.join(save_dir, 'pth' + str(key_i)) 
